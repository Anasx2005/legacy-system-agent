...
const configuredSystemId = Number(import.meta.env.VITE_SYSTEM_ID ?? "1");
    ...
    <div className="app-shell">
      ...
      <main>
        <header className="page-header">
          ...
          <span className="system-chip">System #{configuredSystemId}</span>
        </header>
        <Routes>
          <Route path="/overview" element={<OverviewPage />} />
          <Route
            path="/run"
            element={<RunPage client={client} systemId={configuredSystemId} />}
          />
          <Route
            path="/elements/:elementId?"
            element={<ElementsPage client={client} systemId={configuredSystemId} />}
          />
          <Route
            path="/versions"
            element={<ArtifactVersionsPage client={client} systemId={configuredSystemId} />}
          />
